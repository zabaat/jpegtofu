                    ...
                    <g id="Group-2" transform="translate(58.000000, 0.000000)">
                      ...
                      <g id="Group" transform="translate(6.000000, 6.000000)">
                        ...
                        <g
                          ...
                          stroke-width="2"
                        >
                          <polyline id="Path" stroke="#000000" points="19.6458087 17.3789847 14.3565525 12.0897285 9.06729634 17.3789847" />
                          ...
                          <path
                            ...
                            stroke="#3560FF"
                          />
                          <polyline id="Path" stroke="#3560FF" points="19.6458087 17.3789847 14.3565525 12.0897285 9.06729634 17.3789847" />
                        </g>
                      </g>
                    </g>
                  </g>
...
export default {
  ...
  methods: {
    ...
    async filesAdded(filesObj) {
      console.log('Files Dropped => ', filesObj)
      let files
      if (filesObj instanceof FileList) {
        files = Array.from(filesObj)
      }
